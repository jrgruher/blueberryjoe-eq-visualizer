# Stereo EQ — Streaming Spectrum Analyzer
...
![version](https://img.shields.io/badge/version-0.1-39e6a0)
![license](https://img.shields.io/badge/license-CC%20BY--NC%204.0-blue)

## Screenshot

<!-- Add a screenshot at docs/screenshot.png and it will appear here -->
![Stereo EQ screenshot](docs/screenshot.png)
...
- 📻 60+ pre-loaded, CORS-verified stations (Drum & Bass, Breaks, Lofi, Hip-Hop)
